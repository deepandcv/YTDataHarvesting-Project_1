...
if col2.button('Transfer Data into Mysql'):
  with st.spinner("Transfering Data Please Wiat"):
    t.sleep(5)
    channel_info()
    video_info()
    com_info()
...
def Q1():          
  ...
  a = pd.DataFrame(result_set,columns=[i[0] for i in mycursor.description])
  st.write(a)
